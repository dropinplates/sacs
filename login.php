...
if(isset($_SESSION["userID"])) {
    ...
    if(true): //$sessionUserRole>2
        header("Location:".Info::URL."/methods?module_type=accounting&view=journals&type=lists");
        // $logsMeta='user';
...
<div class="login_wrapper">
    <div class="navbar nav_title">
        <a href="index.html" class="site_title"><span class="iconLogo"><img src="images/cpmpc-logo.png" class="mCS_img_loaded"></span><span class="hide">ProjectZero</span><span><sub class="small hide">ZERO32 iNTERACTIVE</sub></span></a>
    </div>
    <div class="animate form login_form">
        <section class="login_content">
            <form method="post" action="<?php echo Info::URL.'/login.php'?>" class="">
                <h1><?php echo Info::value('systems')['login'];?></h1>
                <div>
