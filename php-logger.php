...
*/
namespace projectzero\phplogger;
/**
...
class logWriter {
    ...
    */
    public function writeLog($message, $severity) {
		...
		$userLog = ['username'=>$_SESSION["username"],'role'=>$_SESSION["role"],'unit'=>$_SESSION["unit"]];
		$userLog = json_encode($userLog, JSON_FORCE_OBJECT);
        // Write time, url, & message to end of file
        fwrite($this->file, "[$time] [$severity] {\"user\": $userLog, \"param\": $message}" . PHP_EOL);
    }
    /**
    * Open log file
    * @return void
